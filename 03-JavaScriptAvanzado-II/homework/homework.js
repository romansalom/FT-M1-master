...
let textoAsteriscos = crearCadena.bind({}, '*', '*'); /// Dado que la función crearCadena no hace uso de this, no es necesario proporcionar un valor para el primer argumento de bind(). Al pasar null en su lugar, indicamos que no se requiere ningún valor específico para this en la función bindeada.
let textoGuiones = crearCadena.bind('', '-', '-');
let textoUnderscore = crearCadena.bind(null, '_', '_'); /// no importa el valor que le ponga como primer paramentro ya que el bind lee el this y en la funcion al no tener un this  cualquier valor que uno le ponga no sera leido por el mismo
